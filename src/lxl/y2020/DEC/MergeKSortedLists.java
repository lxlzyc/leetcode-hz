...
public class MergeKSortedLists {
    ...
    public static void main(String[] args) {
        ...
        c2.next = d2;
        d2.next = e2;
        ListNode[] innerNodes = {a1, a2};

        System.out.println(mergeKSortedLists.mergeKLists3(innerNodes).toString());
    }

    public ListNode mergeKLists3(ListNode[] innerNodes) {
        int l = innerNodes.length;
        if (l == 0) {
            return null;
        }
        ...
        while (!priorityQueue.isEmpty()) {
            ListNode index = priorityQueue.poll();
